...
// Задержка выключения вентилятора охлаждения (D8) после того, как темп. радиатора опустилась
// ниже RADIATOR_FAN_ON_TEMP — защита от дребезга D8 при колебаниях около порога. Независимая
// величина от RADIATOR_FAN_MIN_RUNTIME_MS (та — минимальное время работы перед проверкой отказа
// вентилятора), совпадение значений (обе 60с) — не более чем совпадение.
#define RADIATOR_FAN_OFF_DELAY_MS      60000UL
